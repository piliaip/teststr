...
--//
function UIlibrary:Window(WindowArgs)
  ...
  local Window = Utilities:Create("ScreenGui", {
    ...
    Utilities:Create("Frame", {
      Name = "Main",
      Size = UDim2.new(0, WindowArgs.width or 600, 0, WindowArgs.height or 400),
      BackgroundColor3 = Color3.fromRGB(255, 255, 255), -- Colors.Primary
      ClipsDescendants = true,
      Position = UDim2.new(0, WindowArgs.x or 0, 0, WindowArgs.y or 0),
      --BackgroundTransparency = WindowArgs.transparency or 1
    }, {
      ...
      Utilities:Create("Frame", {
        ...
        BackgroundTransparency = 1,
        Image = "rbxassetid://11144378537",--三角"rbxassetid://7671465363",--打勾"rbxassetid://7710220183",--筆"rbxassetid://11144378537",--點"rbxassetid://3570695787",-- getcustomasset("PPHUD/Resize.png"),
  ...
  local Console = Utilities:Create("Frame", {
    Name = "Console",
    Size = UDim2.new(0, (WindowArgs.width-5) or 500, 0, (WindowArgs.height-50) or 300),
    Parent = Window.Main,
    ...
    }, { Utilities:Create("UIStroke", { Color = Colors.Divider }),
    Utilities:Create("ScrollingFrame", {
      Name = "ConsoleContainer",
      Size = UDim2.new(0, (WindowArgs.width-5) or 500, 0, (WindowArgs.height-62) or 276),
  ...
  local Message = Utilities:Create("Frame", {
    ...
    Size = UDim2.new(0, (WindowArgs.width-10) or 500, 0, 13),
    ZIndex = 11002,
    ...
    function TabTable:Select()
      ...
      function TabTable:Section(SectionArgs)
        ...
        local Section = Utilities:Create("Frame", {
          ...
          BackgroundColor3 = Color3.fromRGB(167, 54, 54),
          BackgroundTransparency = 1,
          Size = UDim2.new(0, 260, 0, 36), -- +64
          --CanvasSize = UDim2.new(0, 130, 0, (WindowArgs.height or 400)-56) -- +64
        }, {
          Utilities:Create("TextLabel", {
            Name = "SectionText",
        ...
        SectionContainer.ChildAdded:Connect(function()
          ...
          Section.Size = UDim2.new(0, 260, 0, SectionY)
          SectionContainer.Size = UDim2.new(0, 260, 0, SectionY)
        end)
...
--                Image = "rbxassetid://7710220183",
        ...
        function SectionTable:Slider(Info)
          ...
          Slider.SliderOuter.SliderButton.MouseButton1Down:Connect(function()
            ...
            MouseMove = Mouse.Move:Connect(function()
              ...
              if Info.Flag then
                UIlibrary.Flags[Info.Flag] = FinalValue
              end
        ...
        function SectionTable:Dropdown(Info)
            ...
            Utilities:Create("Frame", {
              ...
              Utilities:Create("Frame", {
                ...
                Utilities:Create("ImageLabel", {
                  ...
                  BackgroundTransparency = 1,
                  Rotation = 0, -- 180
                  Image = "rbxassetid://7671465363",--getcustomasset("PPHUD/Arrow.png"),
                  AnchorPoint = Vector2.new(.5, .5),
                  Position = UDim2.new(.5, 0, .5, 0),
                  ZIndex = DropdownTable.Index
                })
          ...
          if Info.Default then
            ...
            if Info.Flag then
              UIlibrary[Info.Flag] = Info.Default
            end
